...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="{{ asset('customer/vendor') }}/bootstrap/css/bootstrap.css">
    <!-- Font Awesome CSS-->
                    ...
                    <ul class="menu list-inline mb-0">
                        @if(@auth()->user())
                            @if(@auth()->user()->level == 2)
                                <li class="list-inline-item" style="color: #fff"><a href="{{ url('/profil') }}">{{ auth()->user()->nama }}</a></li>
                            @else
                                <li class="list-inline-item" style="color: #fff"><a href="{{ url('/admin') }}">{{ auth()->user()->nama }}</a></li>
                            @endif
                            <li class="list-inline-item" style="color: #fff"><a href="{{ url('/order') }}">My Orders</a></li>
        ...
        <div class="container"><a href="{{ url('/') }}" class="navbar-brand home"><img src="{{ asset('customer/img') }}/Logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="{{ asset('customer/img') }}/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">J&S - go to homepage</span></a>
            ...
            <div id="navigation" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a href="{{ url('/produk') }}" class="nav-link">Produk Kami</a></li>
                </ul>
                <div class="navbar-buttons d-flex justify-content-end">
                    ...
                    <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block">
                        <a href="{{ url('/cart') }}" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i>
                            ...
                            <span>{{ auth()->user()->cart->count() }} barang di keranjang</span>
                            @endif
                        </a>
                    </div>
                    @endif
