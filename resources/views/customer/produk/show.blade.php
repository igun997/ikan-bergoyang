                                ...
                                <form action="{{ url('/cart/'.$barang->id) }}" method="post">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="form-group text-center d-flex justify-content-center align-items-center flex-column mb-5">
                                            ...
                                            <input type="number" class="form-control form-qty" style="width: 40%" name="qty" value="1" min="1" max="{{$barang->stok}}">
                                        </div>
                                        @if($barang->stok != 0)
                                            <p class="text-center">Stok yang tersedia : {{$barang->stok}}</p>
