...
<div class="block">
    ...
    <div class="block-content">
        ...
        <form class="form-horizontal" action="{{ $url }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-12">Kode Barang</label>
                <div class="col-md-12">
                    <input type="text" name="kodebarang" value="{{ @old('kodebarang') ?? @$barang->kodebarang }}" class="form-control" placeholder="Masukan kode barang">
                </div>
            </div>
            <div class="form-group row">
