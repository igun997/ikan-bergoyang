...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2021 at 04:46 PM
...
(8, 'GMK001', 'Gamis warna kuning', 'Gamis dengan warna kuning dan nyaman dipakai', 1, 50000, 30, 'Gamis warna kuning-1594640049.jpg', '2020-07-13 04:34:09', '2021-01-11 11:58:56', NULL),
(9, 'GMB001', 'Gamis warna biru', 'Gamis dengan warna biru dan nyaman saat dipakai', 1, 55000, 41, 'Gamis warna biru-1594640099.jpg', '2020-07-13 04:34:59', '2021-01-13 07:47:10', NULL),
(10, 'GMP001', 'Gamis warna pink', 'Gamis dengan warna pink dan nyaman dipakai', 1, 50000, 44, 'Gamis warna pink-1594640152.jpg', '2020-07-13 04:35:52', '2021-01-11 11:58:56', NULL),
...
(14, 'GM345', 'Celana', 'adasdasdad', 5, 50000, 0, 'Celana-1607443462.jpg', '2020-12-08 16:04:01', '2021-01-01 08:29:15', NULL);
...
(19, '28', 'Hana', 'yuigahamayuri@gmail.com', 'bandung', '081386542777', 9, 23),
(20, '29', 'yoda', 'akimotoyoda@gmail.com', 'bandung', '081386542778', 9, 22);
...
CREATE TABLE `detail_retur` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `idpembelian` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `detail_retur` (`id`, `idpembelian`, `idbarang`, `qty`, `created_at`, `updated_at`) VALUES
(5, 'tvD6W2RcXU', '9', 1, NULL, NULL),
(6, 'tvD6W2RcXU', '10', 2, NULL, NULL),
(7, 'tvD6W2RcXU', '8', 3, NULL, NULL);
...
(18, '2020_12_17_160206_create_table_retur', 11),
(19, '2020_12_22_210023_add_nullable_constraint_to_my_table', 12),
(20, '2020_12_25_014427_add_user_id_to_retur_table', 13),
(21, '2020_12_29_225820_create_retur_pembelian_table', 14),
(22, '2020_12_29_235519_add_status_to_pembelian_table', 15),
(23, '2020_12_30_000049_add_default_value_to_status_on_pembelian_table', 16),
(24, '2020_12_30_015140_drop_retur_pembelian_table', 17),
(25, '2021_01_01_061929_change_noresi_data_type', 18),
(26, '2021_01_08_230802_create_table_detail_retur', 19);
...
CREATE TABLE `pembelian` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Proses Pemesanan ke Supplier'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pembelian` (`idpembelian`, `idpermintaan`, `idsupplier`, `totalharga`, `keterangan`, `created_at`, `updated_at`, `status`) VALUES
('4BnGQjIfP8', '2', 7, 500000, 'restock gamis biru', '2020-12-25 00:41:52', '2020-12-25 00:41:52', 'Barang sudah diterima'),
('6UxMdSjsj8', '1', 7, 75000, 'adadaqda', '2020-12-08 23:47:29', '2020-12-08 23:47:29', 'Proses Pemesanan ke Supplier'),
('am3SEMgrFj', '5', 7, 100000, 'beli celana', '2020-12-31 00:05:17', '2020-12-31 00:05:41', 'Retur barang'),
('BFKrhkMbjX', '5', 7, 120000, 'iyoask', '2021-01-01 07:51:17', '2021-01-01 15:27:06', 'Retur barang'),
('JaWUIxdXjv', '3', 7, 110000, 'beli lagi', '2020-12-30 00:02:45', '2020-12-30 00:21:27', 'Retur barang'),
('kkCczO79gB', '5', 7, 103000, 'khsad', '2021-01-01 07:47:34', '2021-01-01 07:47:46', 'Retur barang'),
('QGqTY3h2nc', '5', 7, 103000, 'bakoisa', '2021-01-01 15:28:43', '2021-01-01 15:29:15', 'Retur barang'),
('R1ZFJGAPge', '5', 7, 100000, 'ye', '2021-01-01 06:28:45', '2021-01-10 13:00:35', 'Barang sudah diterima'),
('S55DMUbs7F', '5', 7, 100500, 'eyajkjs', '2021-01-01 06:30:09', '2021-01-01 06:30:27', 'Retur barang'),
('tvD6W2RcXU', '6', 7, 3000000, 'restock gamis', '2021-01-08 22:31:31', '2021-01-13 22:44:11', 'Menunggu acc pemilik'),
('UBrfhXbAdY', '4', 7, 500000, 'restock gamis pink', '2020-12-30 01:08:00', '2020-12-30 01:44:14', 'Retur barang');
...
INSERT INTO `penerimaan` (`idpembelian`, `iduser`, `created_at`, `updated_at`) VALUES
('4BnGQjIfP8', 1, '2020-12-25 00:43:25', '2020-12-25 00:43:25'),
('am3SEMgrFj', 1, '2020-12-31 00:05:36', '2020-12-31 00:05:36'),
('BFKrhkMbjX', 1, '2021-01-01 07:51:25', '2021-01-01 07:51:25'),
('JaWUIxdXjv', 1, '2020-12-30 00:12:19', '2020-12-30 00:12:19'),
('kkCczO79gB', 1, '2021-01-01 07:47:39', '2021-01-01 07:47:39'),
('QGqTY3h2nc', 1, '2021-01-01 15:29:01', '2021-01-01 15:29:01'),
('R1ZFJGAPge', 1, '2021-01-01 06:28:50', '2021-01-01 06:28:50'),
('S55DMUbs7F', 1, '2021-01-01 06:30:17', '2021-01-01 06:30:17'),
('tvD6W2RcXU', 1, '2021-01-08 22:31:48', '2021-01-08 22:31:48'),
('UBrfhXbAdY', 1, '2020-12-30 01:08:50', '2020-12-30 01:08:50');
...
('2', 1, '2020-12-25 00:39:04', '2020-12-25 00:39:21', 0),
('3', 1, '2020-12-29 00:59:54', '2020-12-29 01:00:19', 0),
('4', 1, '2020-12-30 01:06:40', '2020-12-30 01:07:03', 0),
('5', 1, '2020-12-31 00:04:15', '2020-12-31 00:04:34', 0),
('6', 1, '2021-01-08 22:30:01', '2021-01-08 22:30:50', 0);
...
CREATE TABLE `retur` (
  ...
  `bukti_barang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `retur` (`id`, `transaksi_id`, `reason`, `bukti_barang`, `status`, `noresi`, `created_at`, `updated_at`, `user_id`) VALUES
(24, 60, 'barang rusak', 'retur-60-1609141166.jpg', 5, '1234246473', '2020-12-28 07:39:27', '2020-12-28 07:56:38', 28),
(26, 59, 'barang rusak', 'retur-59-1609164169.jpg', 10, NULL, '2020-12-28 14:02:49', '2020-12-28 14:03:09', 28),
(30, 63, 'alasan retur', 'retur-63-1609347203.jpg', 5, '1234246', '2020-12-30 16:53:23', '2020-12-30 16:59:57', 28),
(31, 61, 'barang rusak', 'retur-61-1609489902.jpg', 5, '8sklj8d7893j', '2021-01-01 08:31:43', '2021-01-01 08:39:13', 29);
...
INSERT INTO `transaksi` (`id`, `user_id`, `delivery_id`, `status`, `total_harga`, `created_at`, `updated_at`, `buktipembayaran`, `kadaluarsabayar`, `noresi`) VALUES
(59, 28, 19, 5, 55000, '2020-12-17 10:13:30', '2021-01-13 08:05:10', '59-1608200376.png', '2020-12-19 17:13:30', '1234246'),
(60, 28, 19, 5, 50000, '2020-12-17 10:14:44', '2020-12-28 14:18:11', NULL, '2020-12-19 17:14:44', '1234246473'),
(61, 29, 20, 5, 110000, '2020-12-25 06:32:11', '2021-01-01 08:39:13', '61-1608877962.jpg', '2020-12-27 13:32:11', '8sklj8d7893j'),
(62, 29, 20, 3, 50000, '2020-12-25 09:29:34', '2020-12-25 09:33:55', '62-1608888815.jpg', '2020-12-27 16:29:34', NULL),
(63, 28, 19, 5, 50000, '2020-12-30 16:49:37', '2020-12-30 16:59:57', '63-1609347055.jpg', '2021-01-01 23:49:37', '1234246'),
(64, 28, 19, 5, 110000, '2021-01-13 07:47:10', '2021-01-13 08:11:36', '64-1610524056.jpg', '2021-01-15 14:47:10', 'kjhasd673');
...
(8, 'Menunggu Verifikasi Pertugas'),
(9, 'Permintaan Retur Diterima'),
(10, 'Permintaan Retur Ditolak'),
(11, 'Sudah Dikirim dari Customer'),
(12, 'Retur Sedang Diproses');
...
(1, 'Agung', 'pemilik@gmail.com', 'pemilik', 1, NULL, '2019-08-02 08:16:39', '2020-12-08 15:44:07', NULL),
...
(28, 'Hana', 'yuigahamayuri@gmail.com', 'password', 2, NULL, '2020-12-17 08:43:25', '2020-12-17 08:44:31', NULL),
(29, 'yoda', 'akimotoyoda@gmail.com', 'password', 2, NULL, '2020-12-25 06:31:35', '2020-12-25 06:31:35', NULL),
(30, 'Gudang', 'admingudang@gmail.com', 'admingudang', 3, NULL, '2021-01-01 02:37:04', '2021-01-01 02:37:19', NULL),
(31, 'Penjualan', 'adminpenjualan@gmail.com', 'adminpenjualan', 4, NULL, '2021-01-01 02:37:12', '2021-01-01 02:37:24', NULL),
(32, 'rie', 'rie@gmail.com', 'password', 3, NULL, '2021-01-01 11:44:32', '2021-01-01 11:44:32', NULL),
(33, 'fisc', 'fisc@gmail.com', 'password', 4, NULL, '2021-01-01 11:45:21', '2021-01-01 11:45:21', NULL);
...
(28, 'bandung', 9, 23, '081386542777'),
(29, 'bandung', 9, 22, '081386542778'),
(30, '-', 1, 1, NULL),
(31, '-', 1, 1, NULL);
